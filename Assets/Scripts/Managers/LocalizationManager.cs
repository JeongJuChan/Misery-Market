...
public class LocalizationManager : MonoBehaviour
{
    ...
    [SerializeField] private GameData localizationTermsofUse;
    ...
    public void InitLocalization()
    {
        ...
        localizationTermsofUse = Resources.Load<GameData>($"ScriptableObjects/GameData/TermsofUse");
    ...
    {
        var rows = localizationTermsofUse.GetDataRows();
        ...
        for (int i = 0; i < rows.Count; i++)
        {
            ...
            {
                string str = datas[j + 1] == string.Empty ? "\n" : datas[j + 1];
                builders[j].Append(str);
            }
        }

        string localizationKey = rows[0].rowData[0];
        ...
        {
            localizationTextDict[localizationKey][i] = builders[i].ToString();
        }
    }
